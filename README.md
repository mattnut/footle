![Wordle+](https://raw.githubusercontent.com/mattnut/footle/main/public/img/og_1200x630.png)
<div align="center">
  <a href="https://mattnut.github.io/footle/" ><img src="https://github.com/mattnut/footle/workflows/Publish/badge.svg?branch=main" alt="Publish workflow"/></a>
  <img src="https://img.shields.io/github/package-json/v/mattnut/footle" alt="GitHub package.json version" />
</div>

---
A recreation of the popular game [Wordle](https://www.powerlanguage.co.uk/wordle/) by Josh Wardle, with AFL player names from the last 50 years.
Hosted on GitHub pages [here](https://mattnut.github.io/footle/). Based on the 'original' recreation by MikhaD found [here](https://mikhad.github.io/wordle/#daily).
